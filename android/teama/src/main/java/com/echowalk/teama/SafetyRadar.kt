...
data class Hazard(
    ...
    val boxArea: Float = 0f,      // normalized bounding box area [0,1]; larger = closer
    val boxX0: Float = 0f, val boxY0: Float = 0f,  // normalized box coords for overlay
    val boxX1: Float = 1f, val boxY1: Float = 1f,
    val kind: HazardKind,
)
